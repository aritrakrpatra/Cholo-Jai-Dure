          ...
          <div className="relative z-10 mx-auto max-w-7xl px-4 py-10 sm:px-6 sm:py-16 lg:py-20">
            <div className="grid gap-8 lg:grid-cols-[1.65fr_0.95fr] lg:items-end">
              <div className="space-y-4">
                ...
                <h1 className="text-4xl font-bold sm:text-5xl lg:text-6xl">Khajuraho &amp; Chitrakoot</h1>
                <p className="max-w-3xl text-base leading-7 text-white/80 sm:text-lg sm:leading-8 md:text-xl">
                  A compact heritage and spiritual July circuit through Khajuraho and Chitrakoot with curated stays and guided sightseeing.
                </p>
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  <span className="rounded-full border border-white/10 bg-white/5 px-4 py-2 text-xs sm:px-5 sm:py-3 sm:text-sm">
                    3 Nights · 4 Days · July Batch
                  </span>
                </div>
                <div className="flex flex-col gap-2 sm:flex-row sm:flex-wrap sm:gap-3">
                  <BookNowButton packageName="Khajuraho & Chitrakoot" packageId="khajuraho-chitrakoot" />
                  <Link
                    href="/contact"
                ...
                <div className="space-y-4">
                  <div className="rounded-4xl border border-amber-300/10 bg-slate-950/90 p-5">
                    ...
                    <div className="mt-5 space-y-3 text-sm text-white/80">
                      <p><span className="font-semibold text-white">Journey:</span> 30/07/2027</p>
                      <p><span className="font-semibold text-white">Return:</span> 03/08/2027</p>
                      <p><span className="font-semibold text-white">Route:</span> Khajuraho → Khajuraho → Chitrakoot → Return</p>
                    </div>
                  </div>
                  <div className="rounded-4xl border border-white/10 bg-slate-950/90 p-5">
                    ...
                    <p className="mt-4 text-2xl font-semibold text-white">Heritage trails with peaceful spiritual halts.</p>
                  </div>
                </div>
              </aside>
            </div>
        ...
        <section className="py-10 sm:py-14">
          <div className="mx-auto max-w-7xl px-4 sm:px-6">
            <div className="mb-12 text-center">
              ...
              <h2 className="mt-4 text-2xl font-bold sm:text-4xl">Your July journey day by day</h2>
              <p className="mx-auto mt-5 max-w-3xl text-base leading-8 text-white/70 sm:text-lg">
                Experience temple heritage in Khajuraho and spiritual calm in Chitrakoot through a short, well-paced route.
              </p>
            </div>

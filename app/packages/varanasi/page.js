      ...
      <main className="min-h-screen bg-linear-to-br from-slate-950 via-slate-900 to-slate-950 text-white">
        <section className="relative overflow-hidden">
          <div
            ...
            style={{
              backgroundImage:
                "linear-gradient(to bottom, rgba(15,23,42,0.45), rgba(15,23,42,0.92)), url('/varanasi.jpeg')",
            }}
          />
          <div className="relative z-10 mx-auto max-w-7xl px-4 py-10 sm:px-6 sm:py-16 lg:py-20">
            <div className="grid gap-8 lg:grid-cols-[1.65fr_0.95fr] lg:items-end">
              <div className="space-y-4">
                ...
                <h1 className="text-4xl font-bold sm:text-5xl lg:text-6xl">Varanasi</h1>
                <p className="max-w-3xl text-base leading-7 text-white/80 sm:text-lg sm:leading-8 md:text-xl">
                  A sacred January route through Ayodhya, Prayagraj, and Varanasi designed for a calm, spiritually rich experience.
                </p>
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  <span className="rounded-full border border-white/10 bg-white/5 px-4 py-2 text-xs sm:px-5 sm:py-3 sm:text-sm">
                    4 Nights · 5 Days · January Batch
                  </span>
                </div>
                <div className="flex flex-col gap-2 sm:flex-row sm:flex-wrap sm:gap-3">
                  <BookNowButton packageName="Varanasi" packageId="varanasi" />
                  <Link
                    href="/contact"
                ...
                <div className="space-y-4">
                  <div className="rounded-4xl border border-amber-300/10 bg-slate-950/90 p-5">
                    ...
                    <div className="mt-5 space-y-3 text-sm text-white/80">
                      <p><span className="font-semibold text-white">Journey:</span> 08/01/2027</p>
                      <p><span className="font-semibold text-white">Return:</span> 13/01/2027</p>
                      <p><span className="font-semibold text-white">Route:</span> Ayodhya → Prayagraj → Varanasi → Varanasi → Return</p>
                    </div>
                  </div>
                  <div className="rounded-4xl border border-white/10 bg-slate-950/90 p-5">
                    ...
                    <p className="mt-4 text-2xl font-semibold text-white">Pilgrimage route planning with full support.</p>
                  </div>
                </div>
              </aside>
            </div>
        ...
        <section className="py-10 sm:py-14">
          <div className="mx-auto max-w-7xl px-4 sm:px-6">
            <div className="mb-12 text-center">
              ...
              <h2 className="mt-4 text-2xl font-bold sm:text-4xl">Your January journey day by day</h2>
              <p className="mx-auto mt-5 max-w-3xl text-base leading-8 text-white/70 sm:text-lg">
                Follow a spiritual route from Ayodhya to Varanasi with guided movement and comfortable overnight stays.
              </p>
            </div>
